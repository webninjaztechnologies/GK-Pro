                ...
                <div class="git-content">
                    <div class="git-header">
                        ...
                        <div class="contact-detail">
                            ...
                            <ul>
                                <li><a href="tel:<?php the_field('whats_app_number'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/whatsapp.svg" alt=""> <?php the_field('whats_app_number'); ?></a></li>
                                <li><a href="tel:<?php the_field('number'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tele-icon.svg" alt=""><?php the_field('number'); ?></a></li>
                                <li><a href="mailto:<?php the_field('email_text'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mail-icon.svg" alt=""><?php the_field('email_text'); ?></a></li>
                            </ul>
                        </div>
                </div>
            </div>
