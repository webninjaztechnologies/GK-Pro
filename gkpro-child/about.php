                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="es-cont">
                            ...
                            <ul>
                                <li><img src="<?php echo get_template_directory_uri(); ?>/assets/images/checkmark.svg" alt=""><?php the_field('about_list1'); ?></li>
                                <li><img src="<?php echo get_template_directory_uri(); ?>/assets/images/checkmark.svg" alt=""><?php the_field('about_list2'); ?></li>
                                <li><img src="<?php echo get_template_directory_uri(); ?>/assets/images/checkmark.svg" alt=""><?php the_field('about_list3'); ?></li>
                                <li><img src="<?php echo get_template_directory_uri(); ?>/assets/images/checkmark.svg" alt=""><?php the_field('about_list4'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
