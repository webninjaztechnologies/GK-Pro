                    ...
                    <div class="footer-address">
                        ...
                        <div class="footer-tl">
                            <a   class="address-list" href="tel:<?php echo esc_attr(get_theme_mod('footer_phone', '+1 (234) 567 890')); ?>">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/call.svg" alt="Phone">
                        ...
                        <a href="<?php echo esc_url(get_theme_mod('footer_insta_link', '#')); ?>" target="_blank">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insta-1.svg" alt="Insta Logo">
                        </a>
                        <a href="<?php echo esc_url(get_theme_mod('footer_youtube_link', '#')); ?>" target="_blank">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/youtube.svg" alt="Youtube Logo">
                        </a>
                        <a href="<?php echo esc_url(get_theme_mod('footer_twitter_link', '#')); ?>" target="_blank">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/twittre.svg" alt="Twitter Logo">
                        </a>
                        </div>
                    </div>
                </div>
