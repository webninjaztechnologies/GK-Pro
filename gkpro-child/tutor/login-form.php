...
?>
<form id="tutor-login-form" method="post" class="login-form-page">
	...
	<div class="tutor-mb-16">
		...
		<input type="text" class="tutor-form-control login-mail" autocomplete="off" placeholder="<?php esc_html_e( 'Your Email', 'tutor' ); ?>" name="log" value="" size="20" required/>
	</div>
	...
	<div class="tutor-mb-16">
		...
		<div class="pass-login-div">
			<input type="password" class="tutor-form-control login-pass" placeholder="<?php esc_html_e( '********', 'tutor' ); ?>" name="pwd" value="" size="20" required/>
			<button class="pass-hide-show"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Hide.svg" alt="Hide"></button>
		</div>
	</div>
	...
	?>
	<div class="tutor-d-flex tutor-justify-between tutor-align-center tutor-mb-24">
		<div class="tutor-form-check">
			<input id="tutor-login-agmnt-1" type="checkbox" class="tutor-form-check-input tutor-bg-black-40" name="rememberme" value="forever" />
			<label for="tutor-login-agmnt-1" class="tutor-fs-7 tutor-color-muted">
				<?php esc_html_e( 'Remember Me', 'tutor' ); ?>
			</label>
		</div>
	...
	<?php if ( get_option( 'users_can_register', false ) ) : ?>
		<?php
			...
			?>
		<div class="tutor-text-center tutor-fs-6 tutor-color-secondary tutor-mt-16">
			<?php esc_html_e( 'Don\'t have an account yet? ', 'tutor' ); ?>&nbsp;
