...
<?php else : ?>
	...
	<div id="tutor-registration-wrap">
		...
		<form method="post" class="register-form" enctype="multipart/form-data" id="tutor-registration-form">
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" class="first-name" name="first_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'first_name' ) ); ?>" placeholder="<?php esc_attr_e( 'First Name', 'tutor' ); ?>" required autocomplete="off">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" class="last-name" name="last_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'last_name' ) ); ?>" placeholder="<?php esc_attr_e( 'Last Name', 'tutor' ); ?>" required autocomplete="off">
					</div>
				</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" class="user-name" name="user_login" class="tutor_user_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'user_login' ) ); ?>" placeholder="<?php esc_html_e( 'User Name', 'tutor' ); ?>" required autocomplete="username">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" class="reg-email" name="email" value="<?php echo esc_attr( tutor_utils()->input_old( 'email' ) ); ?>" placeholder="<?php esc_html_e( 'E-Mail', 'tutor' ); ?>" required autocomplete="off">
					</div>
				</div>
					...
					<div class="tutor-form-group">
						<div class="tutor-password-strength-checker">
							<div class="tutor-password-field">
								...
								<input class="password-checker" id="tutor-new-password" type="password" name="password" value="<?php echo esc_attr( tutor_utils()->input_old( 'password' ) ); ?>" placeholder="<?php esc_html_e( 'Password', 'tutor' ); ?>" required autocomplete="off" style="margin-bottom: 0;">
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<div class="tutor-form-wrap">
							...
							<input type="password" class="conf-password" name="password_confirmation" value="<?php echo esc_attr( tutor_utils()->input_old( 'password_confirmation' ) ); ?>" placeholder="<?php esc_html_e( 'Password Confirmation', 'tutor' ); ?>" required autocomplete="off" style="margin-bottom: 0;">
						</div>
					</div>
				</div>
			</div>
