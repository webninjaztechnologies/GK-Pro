	...
	if ( $tutor_load_sidebar_actions ) :
		...
		<div class="cr-thumb">
				<?php if ( has_post_thumbnail() ) : ?>
                            ...
                            <?php else : ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/course-img.png" alt="">
                            <?php endif; ?>
				</div>
		...
		if ( $is_enrolled || $is_privileged_user ) {
			...
			if ( ! $is_completed_course ) {
				...
				<form method="post" class="tutor-mt-20">
					...
					<button type="submit" class="tutor-btn tutor-btn-outline-primary tutor-btn-block course-complete-btn" name="complete_course_btn" value="complete_course">
