...
?>
    ...
    <div class="course-price-div">
        <h3>₹<?php echo number_format( $display_price, 0 ); ?>
            <?php if ( $regular_price && $sale_price && $sale_price !== $regular_price ) : ?>
                <span>₹<?php echo number_format( $regular_price, 0 ); ?>
                </span>
            <?php endif; ?>
        </h3>
        ...
        if ( $regular_price && $sale_price && $sale_price !== $regular_price ) {
            ...
            echo '<p>' . esc_html( $discount ) . '% off</p>';
        }
        ?>
    </div>

    <div class="course-exp">
	<!-- <a data-tutor-modal-target="tutor-course-share-opener" href="#" class="custom-share-button">
     <img src="<?php //echo get_template_directory_uri(); ?>/assets/images/export.svg" alt="Export"> 
</a> -->
		<?php
